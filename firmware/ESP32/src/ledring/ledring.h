 ...
 *    - TLM_SENSORS feeds the TOF distances and the LiDAR segment tail.
 *
...
/* From the TLM_SENSORS tap: TOF ranges (mm, Front/Rear/Left/Right) + LiDAR segment
 * tail (mm per angular interval; n = 0 when no fresh LiDAR data). */
