...
typedef enum {
    ...
    LOG_CODE_EKF_WHEEL_SLIP             = 0x0C01u,  /* encoder ω rejected by chi-squared gate */
    ...
    /* Misc / late-add events (append-only — workstation depends on these IDs). */
    LOG_CODE_HX711_TARE_COMPLETE        = 0x0502u,
    LOG_CODE_IMU_CALIB_GAINED           = 0x0604u,
    LOG_CODE_REMOTE_NACK                = 0x010Du,
} log_code_t;
